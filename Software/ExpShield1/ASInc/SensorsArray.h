...
#define SENSOR_NEXTPM		0x05

// Note: There is an averager and a sampler for each physical sensor
#define NUM_OF_TOTAL_SENSORS		(SENSOR_NEXTPM + 1)
...
#define CHANNEL_OPCN3_FIRST				0x0E												// 14
#define CHANNEL_OPCN3_VOLUME			(CHANNEL_OPCN3_FIRST + OPCN3_VOL)
#define CHANNEL_OPCN3_LAST				(CHANNEL_OPCN3_FIRST + OPCN3_CHAN_NUMBER - 1)		// 46

#define CHANNEL_SPS30_FIRST				(CHANNEL_OPCN3_LAST + 1)							// 47
#define CHANNEL_SPS30_LAST				(CHANNEL_SPS30_FIRST + SPS30_NUM_CHANNELS - 1)		// 56

#define CHANNEL_NEXTPM_FIRST			(CHANNEL_SPS30_LAST + 1)							// 57
#define CHANNEL_NEXTPM_LAST				(CHANNEL_NEXTPM_FIRST + NEXTPM_NUM_CHANNELS - 1)	// 65

#define NUM_OF_TOTAL_CHANNELS    		(CHANNEL_NEXTPM_LAST + 1)	// 66
