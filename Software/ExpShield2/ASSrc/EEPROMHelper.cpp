...
bool EEPROMHelper::read(unsigned short address, unsigned char* pData, unsigned char size) {

	HAL_StatusTypeDef res = HAL_I2C_Mem_Read(&hi2c2, MEM24AA256_ADDRESS, address, 0x02, pData, size, 500);
