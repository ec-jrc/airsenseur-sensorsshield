...
public:
	FixedRateSampler(SensorDevice* const sensorDevice, unsigned char fixedPrescaler);
	FixedRateSampler(SensorDevice* const sensorDevice, unsigned char fixedPrescaler, unsigned char fixedDecimation);
